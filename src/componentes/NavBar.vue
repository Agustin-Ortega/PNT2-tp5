<template>
  <div>
    <Header :colorDisplay="colorDisplay" :header="header"></Header><br>
    <div id="navigator">
    ...
    <Colores :squares="squares" :colorDisplay="colorDisplay" @message-display="messageDisplay = $event"
      @restart-text="restartText = $event" @header-background-color="header.backgroundColor = $event">
    </Colores>
  </div>
</template>
